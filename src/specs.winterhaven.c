...
int winterhaven_shout_one(P_char ch, P_char tch, int cmd, char *arg)
{
	...
	if (cmd == CMD_SET_PERIODIC)
		return TRUE;
	if (!tch && !number(0, 4))
		return shout_and_hunt(ch, 5, "&+GGuards! %s &+Gis invading our beloved city! To arms!", NULL, helpers, 0, 0);
	return FALSE;
}
		...
		if (arg && (cmd == CMD_SAY))
		{
			if (isname(arg, "volo"))
			{
				...
				if (obj->timer[0] + 600 <= curr_time)
				{
					...
					act("&+cY&+Lou &+Lthrust $q &+Linto $N&+L's &+rfl&+Re&+rsh &+Land send a &+ct&+Lor&+cr&+Len&+ct &+Lof dark &+cp&+Llanar &+ce&+Lnergy into $S &+cs&+Lou&+cl&+L!&n",
					    TRUE,
					    ch,
					    obj,
					    vict,
					...
					act("$n &+Lthrusts $q &+Linto $N&+L's &+rfl&+Re&+rsh &+Land send a &+ct&+Lor&+cr&+Len&+ct &+Lof dark &+cp&+Llanar &+ce&+Lnergy into $S &+cs&+Lou&+cl&+L!&n",
					    TRUE,
					    ch,
					    obj,
					    vict,
					...
					act("$n &+Lthrust $q &+Linto your &+rfl&+Re&+rsh &+Land send a &+ct&+Lor&+cr&+Len&+ct &+Lof dark &+cp&+Llanar &+ce&+Lnergy into your &+cs&+Lou&+cl&+L!&n",
					    TRUE,
					    ch,
					    obj,
					    vict,
		...
		if (arg && (cmd == CMD_SAY))
		{
			if (isname(arg, "death"))
			{
				...
				if (obj->timer[0] + 600 <= curr_time)
				{
					...
					act("&+LYou grip $q &+Lfirmly in your hand and call upon the &+Rp&+ro&+Rw&+re&+Rr&+rs &+Lof &+BD&+Lar&+Bk&+Lness to aid you in your &+Rb&+ra&+Rttl&+re&+Rs&+L!",
					    TRUE,
					    ch,
					    obj,
					    vict,
					...
					act("$n &+Lgrips $q &+Lfirmly in $s hand and call upon the &+Rp&+ro&+Rw&+re&+Rr&+rs &+Lof &+BD&+Lar&+Bk&+Lness to aid in the &+Rb&+ra&+Rttl&+re&+Rs&+L! ",
					    TRUE,
					    ch,
					    obj,
					    vict,
					...
					if (obj->timer[0] + 600 <= curr_time)
					{
						switch (number(0, 1))
						{
							case 0:
								...
								act("&+LYou grip $q &+Lfirmly in your hand and call upon the &+Rp&+ro&+Rw&+re&+Rr&+rs &+Lof &+BD&+Lar&+Bk&+Lness to aid you in your &+Rs&+re&+Ra&+rr&+Rc&+rh&+L!",
								    TRUE,
								    ch,
								    obj,
								    vict,
								...
								act("$n &+Lgrips $q &+Lfirmly in $s hand and call upon the &+Rp&+ro&+Rw&+re&+Rr&+rs &+Lof &+BD&+Lar&+Bk&+Lness to aid in the &+Rs&+re&+Ra&+rr&+Rc&+rh&+L!",
								    TRUE,
								    ch,
								    obj,
								    vict,
							...
							case 1:
								...
								act("$n says 'I &+Rd&+re&+Rm&+ra&+Rn&+rd &nto know the whereabouts of this mortal's &+Rs&+ro&+Ru&+Rl&n..&n'", TRUE, ch, obj, vict, TO_ROOM);
								act("&n$q &+rr&+Re&+rf&+Ru&+rs&+Re&+rs &+L$n&+L's command and channels the &+Rp&+ro&+Rw&+re&+Rr&+rs &+Lof &+BD&+Lar&+Bk&+Lness upon them!",
								    TRUE,
								    ch,
								    obj,
								    vict,
		...
		if (room == vict->in_room)
		{
			switch (number(0, 1))
			{
				...
				case 1:
					...
					act("&+LYour $q &+rt&+Rea&+rr&+Rs &+Linto $N&+L's &+mth&+Mo&+Cug&+Mh&+mts &+Land unleashes a &+Rvi&+rci&+Rou&+rs &+Lmental &+ra&+Rtt&+ra&+Rck&+L!&n",
					    TRUE,
					    obj->loc.wearing,
					    obj,
					    vict,
					    TO_CHAR);
					act("$n's $q &+rt&+Rea&+rr&+Rs &+Linto your &+mth&+Mo&+Cug&+Mh&+mts &+Land unleashes a &+Rvi&+rci&+Rou&+rs &+Lmental &+ra&+Rtt&+ra&+Rck&+L!&n",
					    TRUE,
					    obj->loc.wearing,
					    obj,
					    vict,
					    TO_VICT);
					act("$n's $q &+rt&+Rea&+rr&+Rs &+Linto $N&+L's &+mth&+Mo&+Cug&+Mh&+mts &+Land unleashes a &+Rvi&+rci&+Rou&+rs &+Lmental &+ra&+Rtt&+ra&+Rck&+L!&n",
					    TRUE,
					    obj->loc.wearing,
					    obj,
					    vict,
	...
	if (arg && (cmd == CMD_SAY))
	{
		if (isname(arg, "ra"))
		{
			...
			if (obj->timer[1] + 750 <= curr_time)
			{
				...
				act("&+LYou &+Yth&+Wr&+Yu&+Wst $q &+Ltowards the sky calling upon the &+Yf&+Wa&+Yb&+Wl&+Ye&+Wd &+Yp&+Wo&+Yw&+We&+Yr&+Ws &+Lof the &+WS&+Yu&+Wn &+YG&+Wo&+Yd&+L!&n",
				    TRUE,
				    ch,
				    obj,
				    vict,
				...
				act("$n &+Yth&+Wr&+Yu&+Wst&+Ys $q &+Ltowards the sky and calls upon the &+Yf&+Wa&+Yb&+Wl&+Ye&+Wd &+Yp&+Wo&+Yw&+We&+Yr&+Ws &+Lof the &+WS&+Yu&+Wn &+YG&+Wo&+Yd&+L!&n",
				    TRUE,
				    ch,
				    obj,
				    vict,
...
int newbie_spellup_mob(P_char ch, P_char victim, int cmd, char *arg)
{
	...
	int ClerBeneSpells[] = {SPELL_ARMOR,
	                        SPELL_BLESS,
	                        SPELL_DETECT_MAGIC,
	...
	int ShamBeneSpells[] = {SPELL_SPIRIT_ARMOR, SPELL_PANTHERSPEED, SPELL_HAWKVISION, SPELL_FIRE_WARD, SPELL_COLD_WARD, SPELL_GREATER_RAVENFLIGHT, 0};

	int DruidBeneSpells[] = {SPELL_BARKSKIN, SPELL_FORTITUDE, SPELL_AID, SPELL_PROTECT_FROM_ANIMAL, SPELL_REGENERATION, 0};
	...
	for (P_char tch = world[ch->in_room].people; tch; tch = tch->next)
	{
		...
		if (!IS_PC(tch) || GET_LEVEL(tch) > 35 || !number(0, 2) || ch->in_room != tch->in_room)
			continue;
		...
		if (spells)
			...
			{
				if (!affected_by_spell(tch, spells[i]) && npc_has_spell_slot(ch, spells[i]))
				{
...
int dragonnia_heart(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	if (cmd == CMD_DEATH)
	{
		...
		debug("&+GDragonnia death: Heart decays in &+C%d&+G obj ticks = &+C%d&+G sec = &+C%d&+G:&+C%02d&+G:&+C%02d&+G.&n", obj->value[0], obj->value[1], obj->value[2], obj->value[3], obj->value[4]);
		logit(LOG_OBJ, "Dragonnia death: Heart decays in %d obj ticks = %d sec = %d:%02d:%02d.", obj->value[0], obj->value[1], obj->value[2], obj->value[3], obj->value[4]);
...
int dragon_heart_decay(P_obj obj, P_char ch, int cmd, char *args)
{
	...
	if (cmd == CMD_EXAMINE)
	{
		generic_find(args, FIND_OBJ_INV | FIND_OBJ_ROOM | FIND_OBJ_EQUIP | FIND_CHAR_ROOM, ch, &carrier, &decayed_heart);
