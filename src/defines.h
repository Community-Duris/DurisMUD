...
#if defined(_SUN4_SOURCE) || defined(__CYGWIN32__) || (defined(_POSIX_SOURCE) && !defined(_SVID_SOURCE)) || defined(_FREEBSD)
typedef unsigned long int ulong;
#endif
#if defined(_SUN4_SOURCE) || (defined(_POSIX_SOURCE) && !defined(_SVID_SOURCE))
...
#define HAS_SURNAME(ch, i) ((i == 1) ? TRUE : ((i == 6) ? (GET_FRAGS(ch) > 2000) : (affected_by_spell(ch, surnames[i].achievement_number))))
...
#define ACT_HUNTER                                                                                                                                                                                     \
	BIT_31                      /* killeristic hunt mode, in which                                                                                                                                     \
