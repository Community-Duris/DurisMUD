...
#define SPELL_ANIMAE_CICATRIX         655
#define SPELL_ENSIS_UNGUIS            656
#define SPELL_LANCEA_CINERALAE        657
#define SPELL_SIMULACRUM_ANGUIS       658
#define SPELL_STIGMATA_DRACONICA      659
#define SPELL_DRAKESCALE_AEGIS        660
#define SPELL_JUDICIUM_FIDEI          661
#define SPELL_IGNEUS_VITAE            662
#define SPELL_SANGUINIS_IGNIS         663
#define SPELL_SANCTUM_DRACONIS        664
#define SPELL_VIVERNAE_CONCORDIA      665
#define SPELL_PACTUM_SERPENTIS        666
#define SPELL_RITUS_DRACONUM          667
#define SPELL_EDICTUM_CINERIS         668
...
#define BREATH_WEAPON_SAVE(ch, vict) (GET_LEVEL(ch) + breath_save_modifier - GET_LEVEL(vict))
