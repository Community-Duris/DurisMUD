...
int dragoon_blade(P_obj, P_char, int, char *);
int dragoon_lance(P_obj, P_char, int, char *);
int dragoon_totem(P_obj, P_char, int, char *);
...
int moonstone(P_obj, P_char, int, char *);
