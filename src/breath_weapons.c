...
void breath_weapon_sleep(int level, P_char ch, char *arg, int type, P_char victim, P_obj obj) { spell_sleep(level, ch, arg, type, victim, obj); }

// Just calling spell_fear for now.
void breath_weapon_fear(int level, P_char ch, char *arg, int type, P_char victim, P_obj obj) { spell_fear(level, ch, arg, type, victim, obj); }

// Just calling spell_minor_paralysis for now.
void breath_weapon_paralysis(int level, P_char ch, char *arg, int type, P_char victim, P_obj obj) { spell_minor_paralysis(level, ch, arg, type, victim, obj); }
