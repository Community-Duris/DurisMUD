...
#define RACE_W_ELEMENTAL     40 /* mob race code: EW */
#define RACE_E_ELEMENTAL     41 /* mob race code: EE */
#define RACE_DEMON           42 /* mob race code: X  */
#define RACE_DEVIL           43 /* mob race code: Y  */
#define RACE_UNDEAD          44 /* mob race code: U  */
#define RACE_VAMPIRE         45 /* mob race code: UV */
#define RACE_GHOST           46 /* mob race code: UG */
#define RACE_LYCANTH         47 /* mob race code: L  */
#define RACE_GIANT           48 /* mob race code: G  */
#define RACE_HALFORC         49 /* mob race code: H2 */
#define RACE_GOLEM           50 /* mob race code: OG */
#define RACE_FAERIE          51 /* mob race code: HF */
#define RACE_DRAGON          52 /* mob race code: D  */
#define RACE_DRAGONKIN       53 /* mob race code: DK */
#define RACE_REPTILE         54 /* mob race code: R  */
#define RACE_SNAKE           55 /* mob race code: RS */
#define RACE_INSECT          56 /* mob race code: I  */
#define RACE_ARACHNID        57 /* mob race code: AS */
#define RACE_AQUATIC_ANIMAL  58 /* mob race code: F  */
#define RACE_FLYING_ANIMAL   59 /* mob race code: B  */
#define RACE_QUADRAPED       60 /* mob race code: AE */
#define RACE_PRIMATE         61 /* mob race code: AA */
#define RACE_HUMANOID        62 /* mob race code: H  */
#define RACE_ANIMAL          63 /* mob race code: A  */
#define RACE_PLANT           64 /* mob race code: VT */
#define RACE_HERBIVORE       65 /* mob race code: AH */
#define RACE_CARNIVORE       66 /* mob race code: AC */
#define RACE_PARASITE        67 /* mob race code: AP */
#define RACE_BEHOLDER        68 /* mob race code: BH */
#define RACE_DRACOLICH       69 /* mob race code: UD */
#define RACE_SLIME           70 /* mob race code: SL */
#define RACE_ANGEL           71 /* mob race code: AN */
#define RACE_RAKSHASA        72 /* mob race code: RA */
#define RACE_CONSTRUCT       73 /* mob race code: CN */
#define RACE_EFREET          74 /* mob race code: E  */
#define RACE_SNOW_OGRE       75 /* mob race code: SO */
#define RACE_BEHOLDERKIN     76 /* mob race code: BK */
#define RACE_ZOMBIE          77 /* mob race code: ZO */
#define RACE_SPECTRE         78 /* mob race code: SP */
#define RACE_SKELETON        79 /* mob race code: SK */
#define RACE_WRAITH          80 /* mob race code: WR */
#define RACE_SHADOW          81 /* mob race code: SW */
#define RACE_PWORM           82 /* mob race code: PW */
#define RACE_AGATHINON       83 /* mob race code: AG */
#define RACE_V_ELEMENTAL     84 /* mob race code: EV */
#define RACE_I_ELEMENTAL     85 /* mob race code: IE */
#define RACE_ELADRIN         86 /* mob race code: EL */
